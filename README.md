# StudySphere API Project Milestones
...
- **What we'll do:**
  - Finalize our project topic.
  - Complete the initial project proposal.
...
### Milestone 2 (Nov Week 2)

- **What we'll do:**
  - Read out OpenAPI docs with request/response schemas and examples and start to create initial documentation on Swagger.
  - Use Git properly (feature branches, meaningful commits) and push to GitHub.
- **Deliverables:**
  - Updated `api.yaml` with examples and parameters.
- **Checklist:**
  - [ ] Updated SwaggerUI documentation with examples
  - [ ] Updated 'api.yaml' file.
  - [ ] GitHub pushed
